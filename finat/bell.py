...
class Bell(PhysicallyMappedElement, ScalarFiatElement):
    ...
    def basis_transformation(self, coordinate_mapping):
        ...
        V = numpy.zeros((18, 21), dtype=object)
        ...
        for v in range(3):
            ...
            V[s+4, s+3] = 2*J[0, 0]*J[1, 0]
            V[s+5, s+3] = J[1, 0]*J[1, 0]
            V[s+3, s+4] = J[0, 0]*J[0, 1]
            V[s+4, s+4] = J[0, 0]*J[1, 1] + J[1, 0]*J[0, 1]
            V[s+5, s+4] = J[1, 0]*J[1, 1]
            V[s+3, s+5] = J[0, 1]*J[0, 1]
            V[s+4, s+5] = 2*J[0, 1]*J[1, 1]
        ...
        for e in range(3):
            ...
            for i in range(3):
                V[v0id+3+i, s] = -1/252 * (pel[e]*foo*tau[i])
                V[v1id+3+i, s] = 1/252 * (pel[e]*foo*tau[i])
